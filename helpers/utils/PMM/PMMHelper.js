...
exports.solveQuadraticFunctionForTarget =
  exports.solveQuadraticFunctionForTrade =
  exports.integrate =
  exports.PMMHelper =
  exports.RStatusBelowOne =
  exports.RStatusAboveOne =
  exports.RStatusOne =
    void 0;
...
var PMMHelper = /** @class */ (function () {
  ...
  PMMHelper.prototype.ROneSellQuote = function (amount, state) {
    return (0, exports.solveQuadraticFunctionForTrade)(
      state.B0,
      state.B0,
      amount,
      new bignumber_js_1.default(1).div(state.OraclePrice),
      state.k
    );
  };
  // =========== helper RAbove ===========
...
var integrate = function (V0, V1, V2, i, k) {
  ...
  var penalty = V0.multipliedBy(V0).div(V1).div(V2).multipliedBy(k);
...
var solveQuadraticFunctionForTrade = function (V0, V1, delta, i, k) {
  ...
  var squareRoot = new bignumber_js_1.default(4)
    ...
    .multipliedBy(V0)
    .multipliedBy(V0);
  squareRoot = bAbs.multipliedBy(bAbs).plus(squareRoot).sqrt();
...
var solveQuadraticFunctionForTarget = function (V1, delta, i, k) {
  if (V1.eq(0)) return new bignumber_js_1.default(0);
  if (k.eq(0)) {
